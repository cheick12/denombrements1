...
export const metadata: Metadata = {
  title: 'Réserver votre chauffeur privé',
  description:
    'Réservez votre VTC premium à Fougères en ligne. Calcul du prix instantané, confirmation par email. Transferts aéroport, longue distance, mise à disposition.',
}
        ...
        <div className="bg-dark-100 border-b border-white/5 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              Formulaire sécurisé · Tarif instantané · Confirmation immédiate
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <aside className="space-y-6">
              ...
              <div className="glass-card rounded-xl p-6">
                <h3 className="text-white font-serif text-lg mb-5">Pourquoi nous choisir ?</h3>
                <ul className="space-y-4">
                  {[
                    { icon: Shield, title: 'Sécurité garantie', sub: 'Assurance pro, véhicule entretenu' },
                    { icon: Clock, title: 'Ponctualité absolue', sub: '0 retard sur 500+ courses' },
                    { icon: Phone, title: 'Joignable 24h/24', sub: 'Par téléphone ou WhatsApp' },
              ...
              {/* Fixed prices */}
              <div className="glass-card rounded-xl p-6">
                <h3 className="text-white font-serif text-lg mb-4">Forfaits aéroport</h3>
                ...
                <p className="text-white/30 text-xs mt-3">
                  Tarifs fixes aller simple depuis Fougères
                </p>
              </div>
              ...
              <div className="p-5 rounded-xl border border-green-500/20 bg-green-500/5">
                ...
                <p className="text-white/40 text-xs mb-4">
                  Contactez-nous directement sur WhatsApp pour un tarif personnalisé.
                </p>
                <a
