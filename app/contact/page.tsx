...
const contactInfo = [
  ...
  },
  {
    icon: MapPin,
    title: 'Localisation',
    value: 'Fougères, Bretagne',
    sub: 'Service dans toute la France',
    href: null,
  },
  {
    icon: Clock,
        ...
        <div className="bg-dark-100 border-b border-white/5 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/50 text-xl max-w-xl mx-auto">
              Une question, un devis, un besoin particulier ? Nous répondons sous 2 heures.
            </p>
          </div>
        </div>
            ...
            <aside className="space-y-4">
              ...
              <div className="p-5 rounded-xl border border-green-500/25 bg-green-500/5">
                ...
                <p className="text-white/40 text-xs mb-4">
                  Pour un devis rapide ou une réservation urgente.
                </p>
                <a
            ...
            <div className="lg:col-span-2">
              {status === 'success' ? (
                <div className="flex flex-col items-center justify-center h-full py-20 text-center gap-4">
                  ...
                  <h3 className="font-serif text-2xl text-white">Message envoyé !</h3>
                  <p className="text-white/50 text-sm max-w-sm">
                    Merci pour votre message. Nous vous répondrons dans les 2 heures.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <h2 className="font-serif text-2xl text-white mb-6">Envoyez-nous un message</h2>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      placeholder="Décrivez votre demande, les dates souhaitées, votre itinéraire…"
